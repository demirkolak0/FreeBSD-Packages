...
pkg install -y i3 i3status i3lock-color feh dmenu alacritty debootstrap thunar xarchiver thunar-archive-plugin unrar rar zip unzip 7-zip xfce4-clipman-plugin networkmgr xdg-user-dirs
